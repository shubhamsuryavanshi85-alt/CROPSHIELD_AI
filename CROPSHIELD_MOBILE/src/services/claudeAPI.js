...
export async function diagnoseCrop({
  ...
  if (!activeKey) {
    activeKey = await AsyncStorage.getItem('cropshield_anthropic_key');
  }
...
All textual explanations and disease names MUST be translated into this language. Do not translate "scientific_name".
...
JSON schema:
{
  ...
  "alternative_diagnoses": [
    { "name": "Bacterial Blight", "probability": 8 },
    { "name": "Nutrient Stress", "probability": 5 }
  ],
  "symptoms_detected": ["Yellowing margins", "Concentric brown rings"]
}`;
